...
public class SwaggerConstant {
    ...
    public static final String CONTACT_EMAIL = "anhbangluckystar@gmail.com";
    public static final String CONTACT_URL = "anhbangluckystar@gmail.com";
    public static final String CONTACT_NAME = "Ecom Hotel API Support";
    public static final String API_TITLE = "Ecom Hotel Management open API";
    ...
    public static final String API_TAG = "Ecom Hotel Service";
}
